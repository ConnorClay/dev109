...
var sunsetHotel = new Hotel('Sunset', 86, 10); // Added sunsetHotel
...
// Add code to display sunsetHotel
var details3 = sunsetHotel.name + ' rooms: ';
details3 += sunsetHotel.checkAvailability();
var elHotel3 = document.createElement('div'); // Create a new div for hotel3
elHotel3.textContent = details3;
document.getElementById('info').appendChild(elHotel3); // Append it to the info div
